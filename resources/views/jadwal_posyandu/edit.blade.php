...
<section class="pt-80 pb-60"
    ...
    <div class="container text-white">
        ...
        <p class="mb-0">Perbarui informasi jadwal kegiatan Posyandu</p>
    </div>
</section>
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('jadwal-posyandu.update', $jadwal->jadwal_id) }}"
                              method="POST"
                                ...
                                <select name="posyandu_id"
                                    ...
                                    @foreach($posyandus as $p)
                                        <option value="{{ $p->posyandu_id }}"
                                            {{ $jadwal->posyandu_id == $p->posyandu_id ? 'selected' : '' }}>
                                            {{ $p->nama }}
                                        </option>
                                    @endforeach
                                </select>
                                <small class="text-muted">Posyandu tidak dapat diubah</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="keterangan"
                                          rows="4"
                                          class="form-control">{{ old('keterangan', $jadwal->keterangan) }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <small class="text-muted">
                                    Upload jika ingin mengganti poster
                                </small>
                                ...
                                <div class="mt-3 text-center">
                                    <img id="posterPreview"
                                         src="{{ $poster
                                                ...
                                                : 'https://via.placeholder.com/600x350?text=Poster+Jadwal' }}"
