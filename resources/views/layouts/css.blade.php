  ...
  <link href="{{asset ('asset-guest/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
  ...
  <link href="{{asset ('asset-guest/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{asset ('asset-guest/vendor/aos/aos.css" rel="stylesheet')}}">
  <link href="{{asset ('asset-guest/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
  <link href="{{asset ('asset-guest/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{asset ('asset-guest/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
